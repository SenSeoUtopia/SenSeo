        ...
        var crawlText = function () {
            ...
            if (trim(text) !== "") {
                ...
                if (block === false && urlRegex.test(text)) {
                    ...
                    $.post(base_url+'/ajax/link_preview', {
                        text: text,
                        ...
                        $('#previewTitle_' + selector).html("<span id='previewSpanTitle_" + selector + "' class='previewSpanTitle' >" + answer.title + "</span><input name='link_title' type='text' value='" + answer.title + "' id='previewInputTitle_" + selector + "' class='previewInputTitle inputPreview' style='display: none;'/>");
                        $('#text_' + selector).css({
                        ...
                        $('#previewDescription_' + selector).html("<span id='previewSpanDescription_" + selector + "' class='previewSpanDescription' >" + answer.description + "</span><textarea id='previewInputDescription_" + selector + "' class='previewInputDescription' style='display: none;' class='inputPreview' name='description'>" + answer.description + "</textarea>");
